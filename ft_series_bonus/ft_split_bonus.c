...
/*   Updated: 2023/01/13 20:50:49 by seungjki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../pipex_bonus.h"

char	*something_like_strchr(char *s, char c)
{
	int	idx;
...
int	str_num_check(char *s, char c)
{
	char	*start_p;
	char	*end_p;
	int		idx;
...
int	str_duplicate(char *s, char c, char **answer)
{
	int		idx;
	int		str_idx;
	char	*start_p;
